...
class UnifiedApiRouteTest(UnifiedApiTestCase):
    ...
    def test_v1_models_exposes_each_opencode_native_protocol(self):
        response = self.client.get(
            "/v1/models",
            headers={"Authorization": "Bearer admin-test-key"},
        )
    ...
    def test_opencode_responses_model_uses_the_native_endpoint(self):
        native_body = (
            b'{"id":"resp_go","object":"response",'

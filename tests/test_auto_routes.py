...
class AutoRouteTest(UnifiedApiTestCase):
    ...
    def test_auto_chat_advances_after_provider_rate_limit(self):
        ...
        self.assertNotIn("reasoning_effort", nano_payload)
        fallback_payload = json.loads(make_request.call_args_list[1].kwargs["data"])
        self.assertEqual(fallback_payload["reasoning_effort"], "max")

...
test("the Worker exports the private container egress entrypoint", async () => {
  ...
  assert.deepEqual(Object.keys(module.MultiLLMProxyContainer.outboundByHost),
    ["intelligence.internal", "knowledge.internal", "ai.internal", "media.internal"]);
  ...
  assert.equal(typeof module.MultiLLMProxyContainer.outboundByHost["media.internal"], "function");
});
